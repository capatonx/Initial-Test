# Honeymoon Trip Context

**Travelers:** Nicole & Charlie
**Duration:** November 6–26, 2026 | 20 nights
**Route:** New York City → New Zealand → Fiji → NYC
...
- **Recommended flight:** Air New Zealand NZ2 — JFK → AKL non-stop (~17.5 hrs, departs ~10:55 pm from JFK Terminal 1, arrives Auckland Sunday Nov 8 ~6:15 am)
- **Alternative:** Air NZ via LAX — NZ5 (JFK→LAX) then NZ1 (LAX→AKL)
- **Airport → ferry:** SkyBus express (~NZD 24 pp, ~1 hr to Britomart/Ferry Terminal) or taxi (~NZD 65–80)
- **Waiheke ferry:** Fullers360 from Pier 1, Quay Street → Matiatia Wharf (~35 min)

### Stop 1: Waiheke Island
- **Dates:** November 8–10, 2026 (2 nights)
- **Accommodation:** Home on Waiheke
- **Transfer in:** SkyBus from airport → Fullers360 ferry from Pier 1 (~35 min)
- **Transfer out (Nov 10):** Fullers360 back to Auckland (~9–10 am), pick up rental car in Auckland CBD, drive to Raglan (~2 hrs)
- **Island transport:** Waiheke Bus Company, taxis, e-bike hire at Matiatia Wharf — no rental car needed on island
- **Highlights:** Wine touring (Tantalus, Mudbrick, Casita Miro), The Oyster Inn, Waiheke harbour
- **November weather:** 19–23°C, sunny with long evenings (light until ~9 pm); high UV — sunscreen essential
...
### Stop 4: Queenstown
- **Dates:** November 13–18, 2026 (5 nights)
- **Accommodation:** QT Queenstown Hotel (Stanley Street)
- **Transfer in:** Flight ROT → AKL → ZQN; Uber or taxi from ZQN (~10 min)
- **Activities & logistics:**
  - Ben Lomond hike (Nov 14): Skyline Gondola (~NZD 32) + 4 hr return summit trail, start by 8 am
  - Mt Cook heli hike (Nov 15): Over The Top Helicopters (OTT) or Heliworks — weather-dependent, book well ahead
...
*Last updated: June 19, 2026 — Automated review session. Content changes (direct to main): flight urgency countdown updated from "~2 weeks remain" to "11 days remain (June 30 deadline)"; Hobbiton timing note updated from "~5 months out" to "~4.5 months out" with added note that Nov 12 morning slots are past the 3–4 month advance booking window; Aqua-Trek, Reel Fiji, and Cloud 9 Resy's slots updated with specific date and "~4.5 months out" urgency context. No trip detail changes. 5 structural PRs remain open and unreviewed (PRs #1–#5): PR #5 (Pre-Trip Booking Checklist, June 12) is the most relevant for current urgency tracking. All trip dates, accommodations, logistics, and activities remain as of May 31, 2026.*
